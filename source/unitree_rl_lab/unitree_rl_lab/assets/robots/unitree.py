...
UNITREE_MODEL_DIR = "/home/xinchen/Dev/Unitree/unitree_model"
# UNITREE_ROS_DIR = "path/to/unitree_ros"  # Replace with the actual path to your unitree_ros package
UNITREE_ROS_DIR = "/home/xinchen/Dev/Unitree/unitree_ros"
...
UNITREE_GO2_CFG = UnitreeArticulationCfg(
    ...
    # spawn=UnitreeUrdfFileCfg(
    #     asset_path=f"{UNITREE_ROS_DIR}/robots/go2_description/urdf/go2_with_payload_description.urdf",
    # ),
...
UNITREE_GO2_WITH_PAYLOAD_CFG = UNITREE_GO2_CFG.replace(
    spawn=UnitreeUrdfFileCfg(
        asset_path=f"{UNITREE_ROS_DIR}/robots/go2_description/urdf/go2_with_payload_description.urdf",
    ),
)
